...
PokemonSpeciesResponse pokemonSpeciesResponseFromJson(String str) => PokemonSpeciesResponse.fromJson(json.decode(str));

String pokemonSpeciesResponseToJson(PokemonSpeciesResponse data) => json.encode(data.toJson());
...
class PokemonSpeciesResponse {
  ...
  factory PokemonSpeciesResponse.fromJson(Map<String, dynamic> json) => PokemonSpeciesResponse(
